...
_cmd_ can be prepended by the mode like 'norm' and then the commands in that mode:
- ~g/<regexp>/norm $di'0P~ - will go to end of line, delete in '-quotes, move to
  beginning of the line and paste what it's just deleted
