...
- `K` - find the man page for word/func below the cursor (for more info look '12.6' section)
...
## editing formatted text (usr_25.txt)
...
editin files in vim with enctyption: `:help 23.3`
